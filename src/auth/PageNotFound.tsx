...
const PageNotFound = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=1470&q=80')",
      }}      
    >
      <div className="bg-white bg-opacity-90 backdrop-blur-md p-8 rounded-2xl shadow-xl max-w-md w-full">
        ...
        <p className="text-gray-600 mb-6">
          Opps Something went wrong. The page you are looking for does not exist.
        </p>
        <Link
          to="/login"
