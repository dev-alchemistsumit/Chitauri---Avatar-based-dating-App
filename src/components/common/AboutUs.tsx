...
const AboutUs = () => {
  return (
    <div className="bg-cyberpunk-bg text-white min-h-screen p-8">
      <h1 className="text-4xl font-bold mb-6">About Companion.ai</h1>
      
      <section className="mb-10">
        <h2 className="text-2xl font-semibold mb-4">Our Mission</h2>
        <p className="text-lg text-gray-300">
          Companion.ai is building the future of relationships. We believe in meaningful emotional
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-300 text-lg">
          Founded by a group of AI enthusiasts and cyberpunk futurists, Companion.ai was born out of
      ...
      <section className="mb-10">
        ...
        <p className="text-lg text-gray-300">
          ...
          Companion.ai, expect AR/VR integrations, multi-avatar interactions, and memory-enabled AI
          partners that grow with you over time.
        </p>
      </section>

      <footer className="text-sm text-gray-500 pt-10 border-t border-gray-700 mt-10">
        &copy; {new Date().getFullYear()} Companion.ai – Engineered for Connection, Designed for You
      </footer>
    </div>
  );
};
